...
const testLogs = [
  { id: 'log-4', date: '2024-01-24T10:00:00Z', vehicleId: 'vehicle-1', isFullTank: true, odometer: 15200 },
  { id: 'log-3', date: '2024-01-20T10:00:00Z', vehicleId: 'vehicle-1', isFullTank: false, odometer: 15000 },
  { id: 'log-2', date: '2024-01-15T10:00:00Z', vehicleId: 'vehicle-1', isFullTank: true, odometer: 14800 },
  { id: 'log-1', date: '2024-01-10T10:00:00Z', vehicleId: 'vehicle-1', isFullTank: true, odometer: 14500 },
];

test('Find previous full tank (skips partial)', () => {
  const result = findPreviousFullFill(testLogs, 'vehicle-1', '2024-01-24T10:00:00Z');
...
test('Find previous full tank from earliest', () => {
  const result = findPreviousFullFill(testLogs, 'vehicle-1', '2024-01-15T10:00:00Z');
  assertEqual(result.id, 'log-1', 'Should find log-1');
});

test('No previous full tank exists', () => {
  const result = findPreviousFullFill(testLogs, 'vehicle-1', '2024-01-10T10:00:00Z');
  assertEqual(result, null, 'Should return null');
});

test('Empty logs array', () => {
  const result = findPreviousFullFill([], 'vehicle-1', '2024-01-24T10:00:00Z');
  assertEqual(result, null, 'Should return null');
});

test('Wrong vehicle ID', () => {
  const result = findPreviousFullFill(testLogs, 'vehicle-2', '2024-01-24T10:00:00Z');
