...
const TankToTankTripCardDemo = () => {
  ...
  const normalTripData = {
    ...
    currentLogId: 'log-2',
    calculatedAt: 'TBD-01-24T10:30:00Z',
    theftThreshold: 25
  };
  ...
  const warningTripData = {
    ...
    previousFullFillLogId: 'log-1',
    currentLogId: 'log-3',
    calculatedAt: 'TBD-01-24T14:30:00Z',
    theftThreshold: 25
  };
  ...
  const criticalTripData = {
    ...
    startDate: 'TBD-01-10T08:00:00Z',
    endDate: 'TBD-01-15T16:00:00Z',
    startOdometer: 10000,
    endOdometer: 10150,
    duration: 432000000,
    durationDays: 5,
    previousFullFillLogId: 'log-1',
    currentLogId: 'log-4',
    calculatedAt: 'TBD-01-15T16:00:00Z',
    theftThreshold: 25
  };
